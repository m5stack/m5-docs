...
次の画像はメイン基板とRS485変換基板の接続を表しています。M-BUSを右の６ピン3.96コネクタにワイヤで接続することも可能です。また右下のRS485変換基板を利用して、シリアルポート（UART2）の出力をRS485レベルへ変換し、４ピン3.96コネクタで出力することができます。
