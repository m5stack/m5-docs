...
<div id="core">
  ...
  <a class="btn btn btn-primary" href="#ja/quick_start/m5core/m5stack_core_quick_start" role="button" style="color:white;margin-top:10px;text-decoration:none">M5Core クイックスタート</a>&nbsp;&nbsp;&nbsp;&nbsp;
  <a class="btn btn btn-primary" href="https://shimo.im/sheets/GWkjHV3XyCCgwDpQ" role="button" style="color:white;margin-top:10px;text-decoration:none" data-toggle="modal" data-target="#Core_I2C">I2C アドレス一覧</a>&nbsp;&nbsp;&nbsp;&nbsp;
  <!-- <a class="btn btn btn-primary" href="https://github.com/m5stack/M5-Schematic/blob/master/Core/hardware_difference_between_cores.md" role="button" style="color:white;text-decoration:none">Cores 比較 »</a> -->
  <a class="btn btn btn-primary" href="https://shimo.im/sheets/GWkjHV3XyCCgwDpQ" role="button" style="color:white;margin-top:10px;text-decoration:none" data-toggle="modal" data-target="#Core_Compare">M5Core 比較 »</a>



<div class="item">
  <a href="/#/ja/core/basic">
...
**M5Stick**
  ...
  <a class="btn btn btn-primary" href="#ja/quick_start/m5stick/m5stick_quick_start" role="button" style="color:white;margin-top:10px;text-decoration:none">M5Stick クイックスタート</a>&nbsp;&nbsp;&nbsp;&nbsp;
  <a class="btn btn btn-primary" href="#ja/quick_start/m5stickc/m5stickc_quick_start" role="button" style="color:white;margin-top:10px;text-decoration:none">M5StickC クイックスタート</a>&nbsp;&nbsp;&nbsp;&nbsp;
  <a class="btn btn btn-primary" href="#ja/quick_start/m5stickv/m5stickv_quick_start" role="button" style="color:white;margin-top:10px;text-decoration:none">M5StickV クイックスタート</a>&nbsp;&nbsp;&nbsp;&nbsp;
  <a class="btn btn btn-primary" href="https://shimo.im/sheets/GWkjHV3XyCCgwDpQ" role="button" style="color:white;margin-top:10px;text-decoration:none" data-toggle="modal" data-target="#Stick_Compare">M5Stick 比較 »</a>
...
**M5GO/FACES キット**
  ...
  <a class="btn btn btn-primary" href="#ja/quick_start/m5core/m5stack_core_quick_start" role="button" style="color:white;margin-top:10px;text-decoration:none">M5GO クイックスタート</a>&nbsp;&nbsp;&nbsp;&nbsp;
  <a class="btn btn btn-primary" href="#ja/quick_start/m5core/m5stack_core_quick_start" role="button" style="color:white;margin-top:10px;text-decoration:none">FACES-kit クイックスタート »</a>
...
<a class="btn btn btn-primary" href="https://shimo.im/sheets/GWkjHV3XyCCgwDpQ" role="button" style="color:white;margin-top:10px;text-decoration:none" data-toggle="modal" data-target="#Module_I2C">I2C アドレス一覧</a>&nbsp;&nbsp;&nbsp;&nbsp;


**通信モジュール**

<div class="item">
  <a href="/#/ja/module/gps">
...
<div class="item">
  <a href="/#/ja/accessory/battery_base">
...
<div id="unit">
  ...
  <a class="btn btn btn-primary" href="#ja/quick_start/m5camera/m5camera_quick_start" role="button" style="color:white;margin-top:10px;text-decoration:none">Camera クイックスタート</a>&nbsp;&nbsp;&nbsp;&nbsp;
  <a class="btn btn btn-primary" href="https://shimo.im/sheets/GWkjHV3XyCCgwDpQ" role="button" style="color:white;margin-top:10px;text-decoration:none" data-toggle="modal" data-target="#Unit_I2C">I2C アドレス一覧</a>&nbsp;&nbsp;&nbsp;&nbsp;
  <a class="btn btn btn-primary" href="https://github.com/m5stack/M5-Schematic/blob/master/Units/m5camera/CameraComparison_en.md" role="button" style="color:white;margin-top:10px;text-decoration:none">カメラ比較 »</a>

**カメラ 部品** 

<!-- **Camera class** *( **[Quick Start](ja/quick_start/m5camera/m5camera_quick_start)**&nbsp;&nbsp;&nbsp;**[Cameras 比較](https://github.com/m5stack/M5-Schematic/blob/master/Units/m5camera/CameraComparison_en.md)** )* -->

<div class="item">
  <a href="/#/ja/unit/esp32cam">
...
<div id="accessory">
     ...
     <span style="font-size:30px">アクセサリ</span>
</div>
...
<div class="item">
  <a href="/#/ja/accessory/cable/grove_cable">
...
<div class="item">
  <a href="/#/ja/accessory/converter/grove2grove">
...
<div class="item">
  <a href="/#/ja/accessory/bus_socket">
