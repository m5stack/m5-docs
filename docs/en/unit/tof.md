...
*Noitce: If you found TOF unstable or for better using experience,you might have old-version hardware PCB board, Following will teach you how to fix the PCB board*
