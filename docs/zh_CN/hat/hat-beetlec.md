...
**Beetlec**是一款迷你机器人小车，采用了双电机驱动器和7个可编程RGB LED，极其简洁的外观设计和板载ESP32的M5StickC小巧主控，使其成为一款独一无二的迷你机器人小车.

它的机身由两部分组成（M5StickC控制器和Beetlec底座.）在底座上，配备了两个由STM32F030驱动的直流减速电机，电路连接至M5StickC的顶部插槽，最终实现控制.
...
    - Base的7个LED将依次点亮3次.
    - 按下按钮A，前轮将前后旋转500ms.
- 使用手机或计算机进行Wi-Fi扫描，搜索并连接ssid名称"beatle",密码为"12345678"加上屏幕上显示的mac地址开头.
