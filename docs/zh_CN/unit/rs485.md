# RS485 - TTL 转 RS485 通信 Unit {docsify-ignore-all}
...
**<mark>RS485</mark>** 是一个用于 TTL 电平转 RS485 电平的 Unit，如果要控制的设备是 RS485 接口的话，将 M5Core 连接这个 Unit 之后，Unit 就可以适配到这个设备的 RS485 接口，从而实现接口转换。这个 Unit 集成了 RS-485 / RS-422 通信收发芯片 MAX485 / SP485EEN。
...
这是两个 M5Core 之间通过 RS485 相互收发数据的例程。

分别下载[例程](https://github.com/m5stack/M5-ProductExampleCodes/tree/master/Module/COMMU/Arduino/RS485)到两个M5Core之后，按下按键 A，然后两个 core 之间会相互发送数据。 -->
