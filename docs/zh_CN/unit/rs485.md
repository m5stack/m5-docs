...
**RS485** 是一个用于 TTL 电平转 RS485 电平的 Unit，如果要控制的设备是 RS485 接口的话，将 M5Core 连接这个 Unit 之后，Unit 就可以适配到这个设备的 RS485 接口，从而实现接口转换。这个 Unit 集成了 RS-485 / RS-422 通信收发芯片 MAX485 / SP485EEN。
