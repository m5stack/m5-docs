...
**RFID**是一款集成 **MFRC522** 射频识别芯片的Unit。MFRC522 工作在 13.56MHz 频段，利用调制解调原理，与感应卡交互数据。MFRC522 支持 MIFARE 更高速的非接触式通信，双向数据传输速率高达 424 kbit/s。利用该unit能实现读卡设备功能，能识别并记录多张卡信息，建立门禁系统、打卡系统、仓库货物进存和小区车辆出入登记等方面的应用。
