...
<table>
   ...
   <tr>
      <td>FIRE</td>
      <td>与PSRAM(G16/17)冲突，使用需要飞线引至另一组 UART 引脚</td>
   </tr>
   <tr>
      <td>CORE2</td>
      <td>占用外部端口G32</td>
...
<a href="https://m5stack.oss-cn-shenzhen.aliyuncs.com/EasyLoader/Module/EasyLoader_NBIOT_MODULE.exe"><el-button type="primary">点击下载EasyLoader</el-button></a>
